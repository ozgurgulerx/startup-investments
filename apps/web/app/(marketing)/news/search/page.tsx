  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="mx-auto w-full max-w-3xl px-6 py-8">
        <div className="mb-8">
          <p className="label-xs text-accent-info">News Intelligence</p>
          <h1 className="mt-2 text-3xl font-light tracking-tight text-foreground">Search</h1>
          <p className="mt-2 max-w-xl text-sm text-muted-foreground leading-relaxed">
            Search across all historical news coverage. Filter by story type, date range, or topic.
          </p>
          <div className="mt-4">
            <Link
              href="/news"
