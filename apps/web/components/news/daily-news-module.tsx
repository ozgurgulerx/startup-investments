...
export function DailyNewsModule({ className, region = 'global' }: DailyNewsModuleProps) {
  const l = region === 'turkey'
    ? {
      ...
      signals: 'sinyal',
      forTopic: 'konu',
      openFullRadar: 'Tam radari ac',
      archive: 'Arsiv',
      scrollBack: 'Gun gun geriye git',
      browseEditions: 'Gunluk edisyonlari zaman icinde karsilastirarak anlatidaki degisimi inceleyin.',
    ...
    : {
      ...
      browseEditions: 'Browse every generated daily edition to see how startup narratives shifted over time.',
