...
Note (2026-02-14): Production automation is VM cron + AKS CronJobs (plus Azure Automation for AKS uptime). GitHub Actions workflows exist as manual backups/ops tooling; GitHub Secrets/Variables may not reflect production state.
