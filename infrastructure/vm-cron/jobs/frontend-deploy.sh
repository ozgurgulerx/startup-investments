...
if [ -n "${POSTHOG_PROJECT_API_KEY:-}" ]; then
    SETTINGS+=("NEXT_PUBLIC_POSTHOG_KEY=${POSTHOG_PROJECT_API_KEY}")
elif [ -n "${POSTHOG_KEY:-}" ]; then
    # Back-compat: legacy key name; prefer POSTHOG_PROJECT_API_KEY.
    SETTINGS+=("NEXT_PUBLIC_POSTHOG_KEY=${POSTHOG_KEY}")
fi
SETTINGS+=("NEXT_PUBLIC_POSTHOG_AUTOCAPTURE=${POSTHOG_AUTOCAPTURE:-false}")
SETTINGS+=("NEXT_PUBLIC_POSTHOG_CAPTURE_PAGELEAVE=${POSTHOG_CAPTURE_PAGELEAVE:-false}")
SETTINGS+=("NEXT_PUBLIC_POSTHOG_CAPTURE_DEAD_CLICKS=${POSTHOG_CAPTURE_DEAD_CLICKS:-false}")
SETTINGS+=("NEXT_PUBLIC_POSTHOG_CAPTURE_EXCEPTIONS=${POSTHOG_CAPTURE_EXCEPTIONS:-true}")
